...
import { scheduleGlowUpNotifications, scheduleDailyTaskNotifications } from '@/utils/glowupNotifications';
...
export default function GlowUpScreen() {
  ...
  const handleAckDisclaimer = useCallback(() => {
    ...
    scheduleDailyTaskNotifications();
  ...
  const SUB_SECTIONS = [
    {
      ...
      items: [
        {
          heading: 'About Facial Asymmetry',
          body: 'Facial asymmetry is normal — most people have it. These evidence-based techniques can reduce visible asymmetry over months of consistent practice.',
        },
        {
          heading: '8 Correction Techniques',
          body: '1. Mewing — Tongue posture on roof of mouth, bilateral pressure. 24/7 practice. Timeline: 6–18 months.\n\n2. Bilateral Chewing — Chew equally on both sides. Use gum or tough foods. Prevents jaw muscle imbalance.\n\n3. Sleep Position — Sleep on your back or alternate sides. Side sleeping compresses one side of the face over time.\n\n4. Facial Massage — 5 min daily. Use upward strokes on the weaker/smaller side. Promotes circulation and muscle tone.\n\n5. Jaw Exercises — Chin tucks, lateral jaw slides, resistance chewing. 10 min/day.\n\n6. Neck & Posture — Forward head posture causes asymmetry. Fix with chin tucks and neck stretches.\n\n7. Unilateral Gum Chewing — Chew on your weaker side for 10 min/day to build up underdeveloped jaw muscles.\n\n8. Bone Remodeling Patience — Bone responds to pressure over years. Consistency beats intensity.',
        },
        {
          heading: 'Important Note',
          body: 'Results vary. These are lifestyle habits, not medical treatments. Severe asymmetry may require professional evaluation.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          body: 'Ancient Ayurvedic practice. Swish 1 tbsp of oil for 15–20 minutes on an empty stomach. Reduces harmful oral bacteria, whitens teeth, and freshens breath.',
        },
        {
          heading: 'Best Oils',
          body: '• Coconut — antimicrobial, pleasant taste (most popular)\n• Sesame — traditional Ayurvedic choice, anti-inflammatory\n• Sunflower — neutral taste, effective',
        },
        {
          heading: 'Protocol',
          body: '1. Morning before eating or drinking\n2. Swish gently — don\'t gargle\n3. Spit into trash (not sink — clogs pipes)\n4. Rinse with warm salt water\n5. Brush teeth\n\nStart with 5 min and work up. If jaw gets tired, you\'re swishing too hard.',
        },
        {
          heading: 'Benefits & Timeline',
          body: '• Reduces harmful oral bacteria\n• Whitens teeth over 2–4 weeks\n• Reduces bad breath\n• May reduce gum inflammation\n\nFrequency: Daily for best results.',
        },
        {
          heading: 'Oral Health Stack',
          body: 'Oil pulling + tongue scraping + water flossing + remineralizing toothpaste (nano-hydroxyapatite)',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          body: 'Cold shower protocol: 30s cold → 30s warm × 3 rounds. Build to full cold showers.\n\nBenefits: dopamine +250%, norepinephrine +300%, brown fat activation, skin tightening.\n\nDo NOT do cold immediately after strength training — wait 4+ hours.',
        },
        {
          heading: '🌬️ Breathwork',
          body: 'Box breathing (4-4-4-4): activates parasympathetic nervous system.\n\nWim Hof: 30 deep breaths + hold. Powerful for energy and cold tolerance.\n\nPhysiological sigh: double inhale + long exhale. Fastest stress reset (1 breath).\n\nUse before bed for sleep, before training for performance.',
        },
        {
          heading: '🦷 Oral Microbiome',
          body: '• Avoid alcohol-based mouthwash (kills good bacteria)\n• Use xylitol gum after meals\n• Eat fermented foods\n• Nasal breathe — mouth breathing disrupts oral pH\n• Tongue scrape every morning',
        },
        {
          heading: '🧠 Cognitive Enhancement',
          body: '• Morning sunlight (10 min) sets circadian rhythm\n• No caffeine for 90 min after waking\n• Lion\'s mane mushroom (500–1000mg)\n• Cold face immersion for alertness\n• Omega-3 (2–3g EPA+DHA daily)',
        },
        {
          heading: '🩸 Lymphatic Flow',
          body: 'Dry brushing before shower (toward heart). Rebounding (mini trampoline). Hydration. Contrast showers.\n\nLymph doesn\'t have a pump — movement is the pump.',
        },
        {
          heading: '🌿 Gut-Skin Axis',
          body: 'Skin reflects gut health.\n\n• Eliminate seed oils\n• Add fermented foods (kimchi, kefir, sauerkraut)\n• Collagen peptides\n• Zinc + Vitamin C for skin repair\n• L-glutamine (5g/day) repairs gut lining',
        },
      ],
    },
  ];
